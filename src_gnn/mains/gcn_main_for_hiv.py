...
from src_gnn.models.gcn import GCN
from src_gnn.trainers.gcn_trainer import GraphTrainer as GcnTrainer
...
def main():
    ...
    # 10 random realizations of train-test split and average, no external valid is needed
